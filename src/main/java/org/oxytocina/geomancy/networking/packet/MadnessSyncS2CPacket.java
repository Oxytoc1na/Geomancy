...
import org.oxytocina.geomancy.util.OctanguliteUtil;

public class MadnessSyncS2CPacket {

    public static void receive(MinecraftClient client, ClientPlayNetworkHandler handler,
                               PacketByteBuf buf, PacketSender responseSender) {
        OctanguliteUtil.setMaddeningSpeed(client.player,buf.readFloat());
        OctanguliteUtil.setMadness(client.player,buf.readFloat());
    }
