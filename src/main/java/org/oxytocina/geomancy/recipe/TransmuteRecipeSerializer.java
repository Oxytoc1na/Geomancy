...
public class TransmuteRecipeSerializer<R extends TransmuteRecipe> implements GatedRecipeSerializer<R> {

    public final TransmuteRecipeSerializer.RecipeFactory<R> recipeFactory;

    public TransmuteRecipeSerializer(TransmuteRecipeSerializer.RecipeFactory<R> recipeFactory) {
