...
public class OctanguliteMaterial implements ArmorMaterial {

    private static final String name                    = "octangulite";
    private static final int toughness                  = 3;
    ...
    private static final Ingredient repairIngredient    = Ingredient.ofItems(ModItems.OCTANGULITE_INGOT);
