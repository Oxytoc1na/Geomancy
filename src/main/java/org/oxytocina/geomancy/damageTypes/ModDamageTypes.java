...
public class ModDamageTypes {
     ...
     */
    public static final RegistryKey<DamageType> DUPLICATE_TRINKETS = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, new Identifier(Geomancy.MOD_ID, "duplicate_trinkets"));
