...
public class ModEntityTypes {
     ...
     */
    public static final EntityType<StellgeEngineer> STELLGE_ENGINEER = registerMob("stellge_engineer",StellgeEngineer::new,new ExtraEntitySettings().dim(0.75f,1.5f).group(SpawnGroup.MONSTER).spawnEgg(0xFFFFFF,0xFFFFFF));

    public static <T extends MobEntity> EntityType<T> registerMob(String id, EntityType.EntityFactory<T> factory, ExtraEntitySettings settings){
        ...
        FabricDefaultAttributeRegistry.register(res, T.createMobAttributes());
