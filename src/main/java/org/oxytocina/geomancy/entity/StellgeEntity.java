...
public abstract class StellgeEntity extends HostileEntity implements Angerable, IStellgeMob, IMobWithHome {

    protected StellgeEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    protected void tickAngerPassing() {
    ...
    protected void angerNearbyStellge() {
        ...
        this.getWorld()
                .getEntitiesByClass(StellgeEntity.class, box, EntityPredicates.EXCEPT_SPECTATOR)
                .stream()
    ...
    protected abstract void playAngrySound();
