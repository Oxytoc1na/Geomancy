...
public class SoulOakTrunkPlacer extends TrunkPlacer {
    public static final Codec<SoulOakTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, SoulOakTrunkPlacer::new));

    public SoulOakTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerTypes.SOUL_OAK_TRUNK_PLACER;
    }
