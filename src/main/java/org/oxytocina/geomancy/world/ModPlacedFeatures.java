...
public class ModPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> SOUL_OAK_TREE_PLACED_KEY = registerKey("soul_oak_tree_placed");
    ...
    public static void boostrap(Registerable<PlacedFeature> context) {
        ...
        register(context, END_RUBY_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.END_RUBY_ORE_KEY),
                ModOrePlacement.modifiersWithCount(12, // Veins per Chunk
                        HeightRangePlacementModifier.uniform(YOffset.fixed(-80), YOffset.fixed(80))));
*/
        register(context, SOUL_OAK_TREE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.SOUL_OAK_TREE_KEY),
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Geomancy.locate(name));
    }
