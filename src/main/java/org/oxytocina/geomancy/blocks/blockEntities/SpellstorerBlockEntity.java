...
public class SpellstorerBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("container."+Geomancy.MOD_ID+".spellstorer_block");
    }
    ...
    public static Function4<Integer, PlayerInventory, SpellstorerBlockEntity, PropertyDelegate,ScreenHandler> getHandler = (a, b, c, d) -> null;
    public static void SetScreenHandler(Function4<Integer, PlayerInventory, SpellstorerBlockEntity, PropertyDelegate,ScreenHandler> f){getHandler=f;}
    ...
    public Inventory getStoredSpellItems(){
        ...
        ItemStack caster = getSlottedCasterItem();
    ...
    public ItemStack getSlottedCasterItem(){
        return getStack(SpellstorerBlockEntity.OUTPUT_SLOT);
    }
}