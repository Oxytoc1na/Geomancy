...
import org.oxytocina.geomancy.client.screen.SpellprinterScreenHandler;
...
public class SpellprinterBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public SpellprinterBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SPELLPRINTER_BLOCK_ENTITY, pos, state);
    ...
    public Text getDisplayName() {
        return Text.translatable("container."+Geomancy.MOD_ID+".spellprinter_block");
    }

    @Nullable
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new SpellprinterScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
    ...
    public ItemStack getOutput(){
        return getStack(SpellprinterBlockEntity.OUTPUT_SLOT);
    }
