...
public class SoulForgeBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if(!world.isClient){
            ...
            if(screenHandlerFactory!=null){
                ...
                AdvancementHelper.grantAdvancementCriterion((ServerPlayerEntity)player,"interaction/simple_ritualforge","simple_ritualforge");
            }
        }
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.RITUALISTIC_FORGE_BLOCK_ENTITY,
