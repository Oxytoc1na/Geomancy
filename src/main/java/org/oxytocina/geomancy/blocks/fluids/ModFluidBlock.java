...
public abstract class ModFluidBlock extends FluidBlock {

    public final BlockState ultrawarmReplacementBlockState;
    public final ModFluid modFluid;

    public ModFluidBlock(ModFluid fluid, BlockState ultrawarmReplacementBlockState, Settings settings) {
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        ...
        ((ModFluid) fluid).onEntityCollision(state, world, pos, entity);
    }
    ...
    public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean notify) {
        if (world.getDimension().ultrawarm() && ultrawarmReplacementBlockState!=null) {
     ...
     */
    public abstract @Nullable BlockState handleFluidCollision(World world, @NotNull FluidState state, @NotNull FluidState otherState);
