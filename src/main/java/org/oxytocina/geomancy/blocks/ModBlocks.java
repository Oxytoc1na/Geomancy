...
public class ModBlocks {
    ...
    // null blocks
    public static final Block NULL_ROCK             = register("null_rock",     Block::new, AbstractBlock.Settings.create().mapColor(MapColor.BLACK).requiresTool().strength(4.0F, 6.0F).sounds(BlockSoundGroup.BASALT).instrument(Instrument.BASEDRUM),ExtraBlockSettings.create().mineableByPickaxe().miningLevel(2),new FabricItemSettings());
    public static final ModFallingBlock NULL_RUBBLE = register("null_rubble", s->new ModFallingBlock(s, Toolbox.colorFromRGB(0.2f,0.2f,0.2f)), AbstractBlock.Settings.create().mapColor(MapColor.BLACK).requiresTool().strength(4.0F, 6.0F).sounds(BlockSoundGroup.BASALT).instrument(Instrument.BASEDRUM),ExtraBlockSettings.create().mineableByShovel().mineableByPickaxe().miningLevel(2),new FabricItemSettings());
    ...
    public static final NullSpikeBlock NULL_SPIKE   = register("null_spike",    NullSpikeBlock::new,AbstractBlock.Settings.create(),ExtraBlockSettings.create().notSimpleCube().cutout());
