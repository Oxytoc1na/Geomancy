...
public class ModBlocks {
    ...
    public static final OctangulitePillarBlock SOUL_OAK_WOOD = register("soul_oak_wood", s->new OctangulitePillarBlock(s,0.3f),AbstractBlock.Settings.create().mapColor(MapColor.SPRUCE_BROWN).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable());
    public static final OctangulitePillarBlock STRIPPED_SOUL_OAK_WOOD = register("stripped_soul_oak_wood", s->new OctangulitePillarBlock(s,0.3f),AbstractBlock.Settings.create().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable());
    public static final OctanguliteBlock SOUL_OAK_PLANKS = register("soul_oak_planks",(s)->new OctanguliteBlock(s,0.3f),AbstractBlock.Settings.copy(Blocks.OAK_PLANKS),ExtraBlockSettings.create(), new Item.Settings());
    ...
    public static final Block SOUL_OAK_SIGN = register("soul_oak_sign",s->new SignBlock(s, ModWoodTypes.SOUL_OAK),AbstractBlock.Settings.create().mapColor(SOUL_OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),ExtraBlockSettings.create().itemHasOwnName());
    public static final Block SOUL_OAK_WALL_SIGN = register("soul_oak_wall_sign",s->new WallSignBlock(s, ModWoodTypes.SOUL_OAK),AbstractBlock.Settings.create().mapColor(SOUL_OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),ExtraBlockSettings.create().itemHasOwnName());
    public static final Block SOUL_OAK_HANGING_SIGN = register("soul_oak_hanging_sign",s->new HangingSignBlock(s, ModWoodTypes.SOUL_OAK),AbstractBlock.Settings.create().mapColor(SOUL_OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),ExtraBlockSettings.create().itemHasOwnName());
    ...
    public static final Block SOUL_OAK_PRESSURE_PLATE = register("soul_oak_pressure_plate",s->new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING,s,ModBlockSetTypes.SOUL_OAK),AbstractBlock.Settings.create().mapColor(SOUL_OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(0.5f).burnable(),ExtraBlockSettings.create().pressurePlate(SOUL_OAK_PLANKS));
    public static final SaplingBlock SOUL_OAK_SAPLING = register("soul_oak_sapling", s->new SaplingBlock(new SoulOakSaplingGenerator(),s),AbstractBlock.Settings.create().mapColor(MapColor.PINK).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).pistonBehavior(PistonBehavior.DESTROY));
    ...
    public static final Block SOUL_OAK_BUTTON = register("soul_oak_button",Blocks.createWoodenButtonBlock(ModBlockSetTypes.SOUL_OAK),ExtraBlockSettings.create().button(SOUL_OAK_PLANKS),new FabricItemSettings());
    public static final Block SOUL_OAK_FENCE_GATE = register("soul_oak_fence_gate",s->new FenceGateBlock(s, ModWoodTypes.SOUL_OAK),AbstractBlock.Settings.create().mapColor(SOUL_OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),ExtraBlockSettings.create().fenceGate(SOUL_OAK_PLANKS),new FabricItemSettings());
    public static final OctanguliteStairsBlock SOUL_OAK_STAIRS = register("soul_oak_stairs",(s)->new OctanguliteStairsBlock(SOUL_OAK_PLANKS.getDefaultState(),s,0.3f),AbstractBlock.Settings.copy(SOUL_OAK_PLANKS),ExtraBlockSettings.create().stairs(SOUL_OAK_PLANKS), new FabricItemSettings());
    public static final OctanguliteSlabBlock SOUL_OAK_SLAB = register("soul_oak_slab",(s)->new OctanguliteSlabBlock(s,0.3f),AbstractBlock.Settings.copy(SOUL_OAK_PLANKS),ExtraBlockSettings.create().slab(SOUL_OAK_PLANKS), new FabricItemSettings());
    public static final OctanguliteFenceBlock SOUL_OAK_FENCE = register("soul_oak_fence",(s)->new OctanguliteFenceBlock(s,0.3f),AbstractBlock.Settings.copy(SOUL_OAK_PLANKS),ExtraBlockSettings.create().fence(SOUL_OAK_PLANKS), new FabricItemSettings());
    public static final OctanguliteDoorBlock SOUL_OAK_DOOR = register("soul_oak_door",(s)->new OctanguliteDoorBlock(s, ModBlockSetTypes.SOUL_OAK,0.3f),AbstractBlock.Settings.copy(SOUL_OAK_PLANKS),ExtraBlockSettings.create(), new FabricItemSettings());
    public static final OctanguliteTrapdoorBlock SOUL_OAK_TRAPDOOR = register("soul_oak_trapdoor",(s)->new OctanguliteTrapdoorBlock(s,ModBlockSetTypes.SOUL_OAK,0.3f),AbstractBlock.Settings.copy(SOUL_OAK_PLANKS),ExtraBlockSettings.create(), new FabricItemSettings());
    ...
    public static final StairsBlock MOLYBDENUM_BRICK_STAIRS = register("molybdenum_brick_stairs", (settings -> new StairsBlock(MOLYBDENUM_BRICKS.getDefaultState(), settings)), AbstractBlock.Settings.copy(MOLYBDENUM_BRICKS),ExtraBlockSettings.copyFrom(MOLYBDENUM_BRICKS).stairs(MOLYBDENUM_BRICKS),new FabricItemSettings());
    public static final SlabBlock MOLYBDENUM_BRICK_SLABS = register("molybdenum_brick_slab", (SlabBlock::new), AbstractBlock.Settings.copy(MOLYBDENUM_BRICKS),ExtraBlockSettings.copyFrom(MOLYBDENUM_BRICKS).slab(MOLYBDENUM_BRICKS),new FabricItemSettings());
    public static final WallBlock MOLYBDENUM_BRICK_WALL = register("molybdenum_brick_wall", (WallBlock::new), AbstractBlock.Settings.copy(MOLYBDENUM_BRICKS).solid(),ExtraBlockSettings.copyFrom(MOLYBDENUM_BRICKS).wall(MOLYBDENUM_BRICKS),new FabricItemSettings());
