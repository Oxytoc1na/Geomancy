...
public class ModBlocks {
    ...
    // block entities
    public static final SmitheryBlock SMITHERY = (SmitheryBlock) register("smithery_block", SmitheryBlock::new, AbstractBlock.Settings.create(), new ExtraBlockSettings().notSimpleCube());
