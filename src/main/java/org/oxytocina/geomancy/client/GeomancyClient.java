...
import org.oxytocina.geomancy.client.blocks.blockEntities.ShiftBlockEntityRenderer;
...
public class GeomancyClient implements ClientModInitializer {
    ...
    public synchronized static void initialize(){
        ...
        BlockEntityRendererFactories.register(ModBlockEntities.SHIFT, ShiftBlockEntityRenderer::new);
