 ...
 */
public class StellgeEngineerRenderer extends MobEntityRenderer<StellgeEngineer, StellgeEngineerModel> {
    ...
    @Override
    public Identifier getTexture(StellgeEngineer entity) {
