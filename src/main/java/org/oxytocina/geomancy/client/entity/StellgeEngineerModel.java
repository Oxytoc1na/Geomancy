...
import org.oxytocina.geomancy.entity.StellgeEngineer;

public class StellgeEngineerModel extends EntityModel<StellgeEngineer> {

    private final ModelPart base;

    public StellgeEngineerModel(ModelPart modelPart) {
    ...
    @Override
    public void setAngles(StellgeEngineer entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
    }
