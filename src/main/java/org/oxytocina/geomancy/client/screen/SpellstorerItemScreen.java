...
public class SpellstorerItemScreen extends HandledScreen<SpellstorerItemScreenHandler> {
    ...
    public SpellstorerItemScreen(SpellstorerItemScreenHandler handler, PlayerInventory inventory, Text title) {
