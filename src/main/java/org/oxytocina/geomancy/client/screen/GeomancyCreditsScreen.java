...
public class GeomancyCreditsScreen extends Screen {
    ...
    private void load(String id, CreditsReader reader) {
        try (Reader reader2 = this.client.getResourceManager().openAsReader(Geomancy.locate(id))) {
            reader.read(reader2);
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        RenderSystem.blendFunc(SrcFactor.ZERO, DstFactor.ONE_MINUS_SRC_COLOR);
