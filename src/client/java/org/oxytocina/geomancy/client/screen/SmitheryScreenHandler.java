...
public class SmitheryScreenHandler extends ScreenHandler {
    ...
    public SmitheryScreenHandler(int syncID, PlayerInventory inventory, PacketByteBuf buf){
        this(syncID,inventory,inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(2));
    }

    public SmitheryScreenHandler(int syncID, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.SMITHERY_SCREEN_HANDLER,syncID);
        ...
        addInventory(inventory,0,9,3,25,11);

        this.addSlot(new Slot(inventory,SmitheryBlockEntity.OUTPUT_SLOT,134,29));
